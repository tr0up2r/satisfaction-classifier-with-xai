...
post_IS_dataloader_train, post_IS_dataloader_test = generate_dataloader(post_df, post_IS_labels_train, post_IS_labels_test, batch_size)
post_ES_dataloader_train, post_ES_dataloader_test = generate_dataloader(post_df, post_ES_labels_train, post_ES_labels_test, batch_size)
comment_IS_dataloader_train, comment_IS_dataloader_test = generate_dataloader(comment_df, comment_IS_labels_train, comment_IS_labels_test, batch_size)
comment_ES_dataloader_train, comment_ES_dataloader_test = generate_dataloader(comment_df, comment_ES_labels_train, comment_ES_labels_test, batch_size)

train_list = [post_IS_dataloader_train, post_ES_dataloader_train, comment_IS_dataloader_train, comment_ES_dataloader_train]
test_list = [post_IS_dataloader_test, post_ES_dataloader_test, comment_IS_dataloader_test, comment_ES_dataloader_test]
