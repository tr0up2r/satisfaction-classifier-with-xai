...
# data_df = pd.read_csv('avg_satisfaction_raw_0-999.csv', encoding='ISO-8859-1')
...
for epoch in tqdm(range(1, epochs + 1)):
    ...
    pred_df.to_csv(f'../predicting-satisfaction-using-graphs/csv/complete_dataset/bert/sep/batch_{batch_size}_lr_1e-5/epoch_{epoch}_predicted_vals.csv')
...
with open(f'../predicting-satisfaction-using-graphs/csv/complete_dataset/bert/sep/batch_{batch_size}_lr_1e-5/training_result.csv', 'w', newline='') as f:
