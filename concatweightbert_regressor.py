...
for epoch in tqdm(range(1, epochs + 1)):
    ...
    pred_df.to_csv(f'../predicting-satisfaction-using-graphs/csv/concatweightbert/batch_{batch_size}_lr_1e-5/epoch_{epoch}_predicted_vals.csv')
...
with open(f'../predicting-satisfaction-using-graphs/csv/concatweightbert/batch_{batch_size}_lr_1e-5/training_result.csv', 'w', newline='') as f:
